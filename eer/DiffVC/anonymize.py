...
def select_random_audio_per_speaker(librispeech_root, subset='train-clean-100', min_duration_sec=1.0):
    """
    ...
    for speaker_id in os.listdir(subset_path):
        ...
        # Filter by duration
        valid_audio_files = [f for f in all_audio_files if is_audio_long_enough(f, min_duration_sec)]
...
if __name__ == "__main__":
    ...
    selected_tgt_files = select_random_audio_per_speaker(librispeech_dir, subset='train-clean-100')
    ...
    speech_dir = "/home/hpc/iwi5/iwi5248h/projects/Speaker Anonymization/LibriSpeech/test-clean"
    ...
    for speaker in os.listdir(speech_dir):
        ...
        for chapter in os.listdir(speaker_dir):
            ...
            for file in os.listdir(chapter_dir):
                ...
                anonymized_speech_file = src_path.replace("LibriSpeech", 'LibriSpeechAnonymized-DiffVC-16KHz')
                ...
                audio = librosa.resample(y=audio.numpy(), orig_sr=22050, target_sr=16000)
                os.makedirs(os.path.dirname(anonymized_speech_file), exist_ok=True)
                sf.write(anonymized_speech_file, audio, 16000, format='flac', subtype='PCM_24')
