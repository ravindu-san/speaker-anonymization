...
class anonymizer_loader:
    def __init__(self):
        self.speech_dir = "/home/hpc/iwi5/iwi5248h/projects/Speaker Anonymization/LibriSpeech/test-clean"
        ...
        for speaker in os.listdir(self.speech_dir):
            ...
            for chapter in os.listdir(speaker_dir):
                ...
                for file in os.listdir(chapter_dir):
                    ...
                    # print(anonymized_speech.shape, anonymized_speech.device)
                    torchaudio.save(anonymized_speech_file, anonymized_speech, 16000)
...
if __name__ == "__main__":
    anonymizer_loader = anonymizer_loader()
    anonymizer_loader.do_anonymize()
